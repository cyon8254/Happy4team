...
<br>
# 백작업<br>
회원가입시 휴대폰 번호로 인증번호를 전송하여 인증을 진행하는 회원가입 기능을 구현 하였습니다.<br>
로그인시 session을 사용하여 로그인을 유지시키고 로그아웃시 session을 날리도록 만들어 로그인과 로그아웃 기능을 구현하였습니다.
모든 페이지에서 동작해야하는 헤더의 알람과 프로필사진을 보여줘야하기 때문에 Interceptor를 이용하여 구현했습니다.<br>
카카오 로그인 OAuth API를 사용하여 좀더 간편하게 회언가입 및 로그인을 할수 있게 구현하였습니.<br>
마이페이지에서 수정 삭제를 만들어 CRUD를 구현하였습니다.<br>
<br>
<br>
# ERD
![ERD](./erd.png)
